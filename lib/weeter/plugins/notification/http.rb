    ...
    module Notification
      class Http
        ...
        def publish_tweet(tweet_item)
          ...
          Weeter::OauthHttp.post(@config, @config.publish_url, {:id => id, :text => text, :twitter_user_id => user_id})
        end
        ...
        def delete_tweet(tweet_item)
          ...
          Weeter::OauthHttp.delete(@config, @config.delete_url, {:id => id, :twitter_user_id => user_id})
        end
      end
    end
  end
